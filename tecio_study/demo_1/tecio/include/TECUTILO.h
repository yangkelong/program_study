 ...
 *   0 for this parameter and later call TecUtilDataFaceMapAssignElemToNodeMap() or TecUtilDataFaceMapAssignElemToNodeMap64() inside
 ...
 *   TecUtilDataFaceMapAssignElemToNodeMap() or TecUtilDataFaceMapAssignElemToNodeMap64() inside a TecUtilDataFaceMapCustomLOD()
 ...
 *
 * @param NumFaceNodes
 *   Total number of nodes for the unique faces. This is not the number of unique
 *   nodes which was given when the zone was added. For example if a face map defined
 *   two triangles polygons that share a common face, NumFaces would be 5 and
 *   NumFaceNodes would be 5*2=10, not 4.
 *
