...
public:
     ...
     */
    virtual void checkout(tecplot::RawArray<tecplot::ItemAddress::SubzoneAddress> const& nodeSubzones) = 0;
     ...
     *     longer needed.
     */
    virtual void checkin(tecplot::RawArray<tecplot::ItemAddress::SubzoneAddress> const& nodeSubzones) = 0;
    ...
    virtual void referencedCellSubzones(
        tecplot::ItemAddress::SubzoneAddress                     nodeSubzone,
        tecplot::RawArray<tecplot::ItemAddress::SubzoneAddress>& cellSubzones) = 0;
     ...
     * and the size()-1.
     */
    virtual tecplot::ItemAddress::ItemOffset_t size(tecplot::ItemAddress::SubzoneAddress nodeSubzone) = 0;
