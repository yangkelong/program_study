...
public:
     ...
     */
    virtual void checkout(tecplot::RawArray<tecplot::ItemAddress::SubzoneAddress> const& subzones) = 0;
     ...
     */
    virtual void checkin(tecplot::RawArray<tecplot::ItemAddress::SubzoneAddress> const& subzones) = 0;
     ...
     */
    virtual double fieldValue(tecplot::ItemAddress itemAddress) = 0;
    ...
    virtual void fieldValues(
        tecplot::RawArray<tecplot::ItemAddress> const& itemAddresses,
