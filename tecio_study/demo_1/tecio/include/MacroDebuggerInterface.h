...
public:
    ...
    virtual char const* const rawMacroVarName(int macroVar) const = 0;
    ...
    virtual char const* const rawMacroCommandCommandString() const = 0;      // Fetch raw character string for cur command
    virtual char const* const rawMacroCommandFunctionString() const = 0;     // Fetch raw character string for cur function name
